...
public class EditListOfTtransportConpanyController {
	 ...
	 * @param data
	 */
	public void addNewTransportCompany(String data){
	...
	public void deleteListOfTransportCompanies(){
	 ...
	 * @param company
	 */
	public void deleteSelectedTransportCompany(TransportCompany company){
	 ...
	 * @param company
	 */
	public void setNewInformationOfTransportCompany(TransportCompany company){
