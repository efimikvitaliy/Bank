...
m_LoginController.isManager(m_LoginController.getUser().getType());
						if(b)
						{
							jf.setVisible(false);
						}
					...
					{
						JOptionPane.showMessageDialog(jf, "DataBase is not available");
					}
				}
			}
		});
		jb2.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				int res = JOptionPane.showConfirmDialog(jf, "Do you want exit?", "Exit", 
